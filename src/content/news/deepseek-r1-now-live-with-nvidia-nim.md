...
subtitle: "An insightful look into 'DeepSeek-R1 Now Live With NVIDIA NIM'"
description: "NVIDIA has unleashed its groundbreaking AI model, DeepSeek-R1, now available as a microservice preview on build.nvidia.com. With an astounding 671 billion parameters, DeepSeek-R1 excels in logical reasoning, math, coding, and language tasks through multiple inference passes, implementing advanced test-time scaling. This open model leverages NVIDIA's state-of-the-art accelerated computing to perform up to 3,872 tokens per second on a single HGX H200 system, highlighting NVIDIA's commitment to pushing AI boundaries with unprecedented accuracy and efficiency for agentic AI systems. Developers can leverage NVIDIA NIM for secure experimentation and deployment, unlocking potential for tailored AI agents with robust data privacy. Powered by NVIDIA's Hopper architecture, enterprises can expect seamless integrations with"
publishedOn: 2025-04-07
updatedOn: 2025-02-06
mainImage: "https://cdn.prod.website-files.com/672916ba596e9ad764eea6e4/679ffff13a463cec964eaa76_tmpa8qt_o6b.png"
thumbnail: ""
altTextThumbnail: ""
altTextMainImage: "A visually stunning main image for the article: DeepSeek-R1 Now Live With NVIDIA NIM"
